      ...
      <div>
        ...
        >
          ...
          <section className="mt-8">
            ...
            <p
              className={`leading-relaxed mt-4 text-lg  ${poppins.className} `}
            >
              ...
              governance model, a focus on security, and an active community,
              SIMS seeks to create a welcoming and resilient platform for all
              members.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p className={`leading-relaxed mt-4 text-lg ${poppins.className} `}>
              The SIMS project was established on four core values that drive
              our community: trust, respect, inclusivity, and integrity. As a
              ...
              and appreciated. Every SIMS community member is a vital part of
              this ecosystem, united by a shared vision to make a positive
          ...
          <section className="mt-8 text-left">
            ...
            <h3
              className={`text-2xl font-semibold mt-4  ${orbitron.className} `}
            >
              Vision
            </h3>
            <p
            ...
            >
              To establish SIMS as a transparent, ethical, and
              community-centered cryptocurrency project where each member’s
              voice matters, and every action reflects the principles of
            ...
            >
              ...
              create a decentralized platform that empowers individuals,
              embraces diverse voices, and fosters an atmosphere of mutual
          ...
          <section className="mt-8">
            ...
            <h3
              className={`text-3xl font-semibold mt-4  ${orbitron.className} `}
            >
              3.1 Community-Led Decision Making
            </h3>
            <p
              className={`leading-relaxed mt-2 text-lg  ${poppins.className} `}
            >
              SIMS operates on a community-driven governance model. Key
              decisions are made through community voting, ensuring that the
              direction of the project aligns with the collective will of the
              members. This model provides each member with a stake in
              SIMS&rsquo;s future, reinforcing the project&rsquo;s commitment to
            ...
            >
              ...
              every proposal undergoes thorough consideration and that all
              voices are heard.
            </p>
          </section>
          <section className="mt-8">
            ...
            >
              ...
              requires approval from multiple trusted signers, ensuring that
              funds are managed responsibly and with consensus. The use of
              multi-sig wallets also mitigates the risk of single-point failures
            ...
            <p
              className={`leading-relaxed mt-2 text-lg  ${poppins.className} `}
            >
              In response to previous incidents that jeopardized community
              trust, SIMS leadership took decisive steps to restore integrity. A
              new wallet was created, secured by reliable, community-trusted
              signers, and funded to demonstrate a renewed commitment to
              security. This act of transparency and accountability is central
              to SIMS&rsquo;s pledge to protect community assets and reinforce
          ...
          <section className="mt-8">
            ...
            >
              ...
              transparency, and storytelling. The project has a dedicated plan
              for promoting SIMS through community-led marketing efforts that
            ...
            <p
              className={`leading-relaxed mt-2 text-lg  ${poppins.className} `}
            >
              SIMS has created a unique lore that resonates with its members.
              For instance, the initial &ldquo;50 SOL buy and burn&rdquo; story
              serves as a rallying point, encouraging new participants to
              contribute. The narrative centers on the shared journey and trials
              that the community has faced and overcome, fostering a sense of
              unity and purpose.
            </p>
          </section>
            ...
            <div className="mt-8  max-w-3xl ">
              ...
              >
                ...
                <li>
                  ...
                  spirit, lore, and values. This collection will serve as a
                  symbol of belonging and recognition within the SIMS ecosystem.
                  <ul className="list-disc pl-8 mt-2">
                    <li>
                      <span className="font-semibold ">Purpose:</span> The NFT
                      collection will provide members with unique, digital
                      assets that reinforce their connection to SIMS.
                    </li>
                    <li>
          ...
          <section className={`mt-8 `}>
            ...
            <p className={`leading-relaxed mt-4 text-lg ${poppins.className}`}>
              TThe SIMS project is no stranger to adversity. Past challenges
              have tested the community&rsquo;s resilience, leading to the
              creation of a security-enhanced, multi-signature wallet and
              renewed pledges from leadership. These experiences have reinforced
              SIMS&rsquo;s commitment to integrity, inspiring the community to
              continue building and adapting.
            </p>
          </section>
          ...
          >
            ...
            <p className={`leading-relaxed mt-4 text-lg ${poppins.className} `}>
              ...
              deflationary mechanisms, strategic marketing, and
              community-oriented initiatives. This structure is designed to
              support long-term growth, enhance the token’s value, and empower
              community members.
            </p>
            ...
            <div className="mt-8 ">
              ...
              >
                <li>
                  ...
                  The OBW holds a significant portion of burned $SIMS,
                  effectively removing these tokens from circulation. This
                  wallet’s transactions are publicly verifiable on Solscan.
                </li>
                <li>
                  <span className="font-semibold ">
                ...
                <li>
                  ...
                  will vote on the 4 SOL balance allocation, with 50 million
                  $SIMS to be burned as per community vote.
                </li>
                <li>
                  <span className="font-semibold ">Total Burned Supply:</span>{" "}
                  With 136.23 million $SIMS in OBW and 50 million $SIMS locked
                  in LMW, the total burned supply stands at 18.62% of the
                  initial supply as of 11/4/2024.
                </li>
              </ul>
              ...
              >
                ...
                voting, ensuring transparency, accountability, and alignment
                ...
                <li>
                  ...
                  <ul className="list-disc pl-8 mt-2">
                    <li>
                      ...
                      Community votes determine campaigns, including social
                      media promotions, ads, or strategic partnerships.
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className="list-disc pl-8 mt-2">
                    ...
                    <li>
                      Community voting directs funds to meaningful causes
                      aligned with SIMS’s values.
                    </li>
                  </ul>
                </li>
              </ul>
          ...
          <section className="mt-8 text-left max-w-3xl mx-auto">
            ...
            <p className={`leading-relaxed mt-4 text-lg ${poppins.className} `}>
              SIMS is not just a coin; it is a movement for inclusivity,
              respect, and integrity. Through our shared commitment and
              relentless drive, SIMS will remain a pioneering example of
              community-led cryptocurrency. Together, we aim for the
              stars—united, resilient, and unstoppable.
            </p>

            <h3
              className={`text-2xl font-semibold mt-6  ${orbitron.className}`}
            >
              Connect with us.
            </h3>
          ...
          <section className="mt-8">
            ...
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
              ...
              provided in this document and on all associated platforms,
              including websites, social media channels, and promotional
              materials, is for informational and entertainment purposes only.
              SIMS CTO Meme Coin hereinafter referred to as “SIMS” is a novelty
              cryptocurrency and is not intended as an investment vehicle, nor
              does it claim to offer any financial returns, promises, or
              guarantees. The Coin is driven primarily by community
              participation and interest and holds no inherent or intrinsic
              value.
            </p>
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
            ...
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
              ...
              this document or any communication from the SIMS CTO Meme Coin
              team should be interpreted as financial, legal, or investment
              advice. We recommend consulting with a qualified financial advisor
              before making any investment decisions. The Coin is created for
            ...
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
              ...
              are legally permitted to participate in your jurisdiction and
              accept sole responsibility for complying with any applicable legal
              or regulatory requirements.
            </p>
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
              <strong className={``}>No Guarantees or Promises:</strong> The
              Coin is not affiliated with any corporation, brand, or individual
              named “SIMS” There are no assurances that any specific product
            ...
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
              ...
              SIMS CTO Meme Coin is not affiliated with, endorsed by, or
              connected to The Sims video game, its publisher Electronic Arts
              (EA), or any of its subsidiaries or affiliates. Any resemblance to
              names, themes, or concepts is coincidental and should not be
              interpreted as an association with the game The Sims or its
            ...
            <p className={`leading-relaxed mt-4 text-lg  ${poppins.className}`}>
              ...
              use, purchase, or holding of the Coin. By participating in SIMS
              CTO Meme Coin, you acknowledge that you have read, understood, and
