...
export default function Comic() {
  ...
  return (
    <div className={`${styles.homeBackground} min-h-screen flex flex-col`}>
      {/* Main Content */}
      <main className="flex flex-col items-center  w-full pt-36 space-y-8 px-6">
        ...
        <div className="flex justify-center space-x-6 mt-8">
          ...
          <button
            onClick={() => router.push("/")}
            className="px-8 py-3 bg-purple-500 text-white rounded-full shadow-md hover:bg-purple-600 transition mt-6"
          >
            Go to Home
          </button>
        </div>
