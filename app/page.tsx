...
export default function Home() {
  ...
  return (
    <PageLayout>
      <div className={` ${orbitron.className} z-10`}>
        <main className="flex flex-col items-center justify-start min-h-screen pt-32 text-center space-y-8 px-8">
          ...
          <section className="text-center max-w-lg">
            ...
            >
              ...
              collaborate on projects, and earn rewards. Join us as we explore
              new ways to connect, create, and play together in the Sims
              universe!
            </p>
              ...
              {showWhySims && (
                ...
                >
                  ...
                  <p className={`${poppins.className} leading-relaxed`}>
                    ...
                    Every day growing and learning more about what fits where,
                    and who’s good at what. We have finally found a purpose here
                    at SIMS CTO and I believe that purpose is to DREAM.
                  </p>
                  <p className={`${poppins.className} leading-relaxed`}>
              ...
              {showJoinUs && (
                <>
                  <p
                    className={`mt-4  ${poppins.className} leading-relaxed  ${styles["text-container"]}`}
                  >
                    Our community-driven journey is only just beginning, and
                    your support can make all the difference! By contributing to
                    the{" "}
                    <span className=" font-bold">SIMS Marketing Wallet</span>,
                    you’re helping fuel our mission of transparency,
                    inclusivity, and empowerment within the decentralized
                    finance space.
                  </p>
                  <p
                    className={`mt-4  ${poppins.className} leading-relaxed  ${styles["text-container"]}`}
